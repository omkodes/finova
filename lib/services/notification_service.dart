...
class NotificationService {
  ...
  Future<void> scheduleDailyTenPMNotification() async {
    try {
      await flutterLocalNotificationsPlugin.zonedSchedule(
        id: 0,
        title: 'Finova - Daily Check-in',
        body:
            'It\'s 10 PM! Don\'t forget to log today\'s expenses and stay on track with your goals.',
